...
//struct PlayerControls3D: View {
//	@Environment(\.colorScheme) var colorScheme
//
//	var conductor: ProcessesPlayer3DInput
//
//	let sources: [[String]] = [
//		["Bass Synth", "Bass Synth.mp3"],
//		["Drums", "beat.aiff"],
...
//		.sheet(isPresented: $isShowingSources,
//			   onDismiss: { print("finished!") },
//			   content: { SourceAudio3DSheet(playerControls: self) })
//	}
//
//	func load(filename: String) {
//		conductor.player.stop()
...
//
//
//struct SourceAudio3DSheet: View {
//	@Environment(\.presentationMode) var presentationMode
//
//	var playerControls: PlayerControls3D
//	@State var browseFiles = false
//	@State var fileURL = URL(fileURLWithPath: "")
//
//	var body: some View {
